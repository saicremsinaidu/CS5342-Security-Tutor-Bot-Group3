...
* **Round 1 Deliverables (Due: 10/10/2025)**:
    * ✅ Group Report (`group3__Task1report.docx`) submitted.
    * ✅ Contribution Table included in the report.
    * ✅ GitHub repository has been set up and organized.
* **Current Focus**:
    * Developing preprocessing scripts for course materials.
    * Setting up the embedding model for the tutor bot.
